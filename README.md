...
- [![BrainBytes CI/CD](https://github.com/kurtsanor/brainbytes/actions/workflows/main.yml/badge.svg)](https://github.com/kurtsanor/brainbytes/actions/workflows/main.yml) - Shows the status of the main CI/CD pipeline
- [![BrainBytes Deploy](https://github.com/kurtsanor/brainbytes/actions/workflows/deploy.yml/badge.svg)](https://github.com/kurtsanor/brainbytes/actions/workflows/deploy.yml) - Shows the status of the deployment workflow
